    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            align-items: center;
            padding: 20px;
            background-image: radial-gradient(circle at 10% 20%, rgba(0, 13, 255, 0.1) 0%, rgba(0, 13, 255, 0.05) 90%);
        }
...
<body>
    ...
    <div class="links-container">
        ...
        <!-- Link 7 -->
        <div class="link-item">
            <a href="https://wa.me/+6285179704137" target="_blank" class="link-btn">
                <div class="link-icon">
                    <i class="fab fa-whatsapp"></i>
                </div>
                <div class="link-text">
